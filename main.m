...
if isnan(skips) || fix(skips) ~= input_hf
...
elseif strcmp(ballColor, 'White')
    ...
    BALL_COLOR_HSV_MAX = [1, h+h_threshold/255, 1];
else
    disp('Invalid! Accepted Colors: Orange or White');
    return;
end
...
% for accuracy the user should select the first ROI
first_frame = true;
